package com.cool.structuredconcurrency.executor;
...
import com.cool.structuredconcurrency.LongRunningTask;
...
public class StructuredTaskScopeOnFailureExecutor {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Map<String,TaskResponse> result 
            = StructuredTaskScopeOnFailureExecutor.execute(List.of(dbTask, extTask, restTask));
